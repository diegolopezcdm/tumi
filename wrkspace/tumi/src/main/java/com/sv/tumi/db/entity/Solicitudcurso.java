 ...
 */
@Entity
@Table(name = "solicitudcurso")
@NamedQueries({
    @NamedQuery(name = "Solicitudcurso.findAll", query = "SELECT s FROM Solicitudcurso s")})
public class Solicitudcurso implements Serializable {
    ...
    public Solicitudcurso(Integer codigo) {
        this.codigo = codigo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Solicitudcurso)) {
            return false;
        }
        Solicitudcurso other = (Solicitudcurso) object;
    ...
    public String toString() {
        return "com.sv.tumi.db.entity.Solicitudcurso[ codigo=" + codigo + " ]";
    }
